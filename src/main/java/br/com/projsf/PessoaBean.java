...
public class PessoaBean {
	...
	public void pesquisaCep(AjaxBehaviorEvent ajaxBehaviorEvent) {
	...
	public List<SelectItem> getEstados() {
		estados = iDaoPessoa.listasEstados();
		return estados;
	}
	...
	public void dowload() throws IOException {
		...
		response.setContentLength(pessoa.getFotoBase64Original().length);
		response.getOutputStream().write(pessoa.getFotoBase64Original());
